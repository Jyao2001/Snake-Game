/*
    ...
    notes - things the reader of your code (including you, yourself) should be aware of (e.g., a list of things you might want to fix, change, add, etc. in future versions of the program)
    comments - anything not included in the above that the reader should be aware of (e.g. external links to related information)
    Wikipedia article on refactoring: https://en.wikipedia.org/wiki/Code_refactoring
    //don't forget the random number generator
